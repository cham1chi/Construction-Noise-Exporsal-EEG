...
load('loud_sharp_rough_fluctuation_lab3.mat')  %  acousticDATA
%%%%%%%%%%%%%%%%%%%%%%%
...
code1=noise(1:35,1:4);
code2=noise(36:70,1:4);
code3= noise(71:104,1:4);
code4= noise(105:138,1:4);
code5= noise(139:172,1:4);
code6= noise(173:206,1:4);
%%%%%%%%%%%%%%%%%%%%%%
...
%%%%%%%%%%%%%%%%%%%%%%%%
summary1khz = vertcat( R1khz(1, 5:16), P1khz(1, 5:16),R1khz(2, 5:16), P1khz(2, 5:16),R1khz(3, 5:16), P1khz(3, 5:16),R1khz(4, 5:16), P1khz(4, 5:16));%????????
% R 상관계수 P 유의확률 
summary4khz = vertcat( R4khz(1, 5:16), P4khz(1, 5:16),R4khz(2, 5:16), P4khz(2, 5:16),R4khz(3, 5:16), P4khz(3, 5:16),R4khz(4, 5:16), P4khz(4, 5:16));
