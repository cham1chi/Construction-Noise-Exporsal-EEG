...
load('dif_mean_erp.mat')  %  dif_mean_erp).mat or dif_mean_erp).mat
% 소음종류가 동일할때 hz 별 대응표본  semiP3 or dif_mean_erp)
ex1= dif_mean_erp(1:35,1:6);
ex2= dif_mean_erp(36:70,1:6);
ex3= dif_mean_erp(71:104,1:6);
ex4= dif_mean_erp(105:138,1:6);
ex5= dif_mean_erp(139:172,1:6);
ex6= dif_mean_erp(173:206,1:6);
hzex1= dif_mean_erp(1:35,1:6);
hzex2= dif_mean_erp(36:70,1:6);
hzex3= dif_mean_erp(71:104,1:6);
hzex4= dif_mean_erp(105:138,1:6);
hzex5= dif_mean_erp(139:172,1:6);
hzex6= dif_mean_erp(173:206,1:6);
