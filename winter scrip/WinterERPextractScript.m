...
EEG = pop_biosig('C:\Users\my\Documents\MATLAB\eeglab14_1_2b\winter raw edf\dump\1khz\wintet9_1khz_dump.edf');  %% 수정
...
EEG = pop_epochbin( EEG , [-200.0  800.0],  'pre'); % GUI: 09-Jan-2020 13:59:38
...
EEG  = pop_artextval( EEG , 'Channel',  1:14, 'Flag',  1, 'Threshold', [ -100 100], 'Twindow', [ -200.0 789.1] ); % GUI: 09-Jan-2020 15:04:19   Threshold 기본값: [ -100 100]
EEG  = pop_basicfilter( EEG,  1:14 , 'Cutoff', [ 1.0 20.0], 'Design', 'butter', 'Filter', 'bandpass', 'Order',  2 ); % GUI: 09-Jan-2020 15:07:42  필터대역 기본값: [ 0.5 30.8]
...
%저장erp.파일   %%수정
ERP = pop_savemyerp(ERP, 'erpname', 'winter1', 'filename', 'winter9_1khz_dump.erp', 'filepath', 'C:\Users\my\Documents\MATLAB\eeglab14_1_2b\wintererp\dump\1khz');% Script: 09-Jan-2020 14:11:37
